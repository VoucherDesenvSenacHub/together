...
<body>
    ...
    <div class="sobre-nos-section">
        <div class="sobre-nos-text-container">
            <div class="sobre-nos-content">
                ...
                <p>Desenvolvemos uma plataforma para ajudar no gerenciamento de ONGs, trazendo grandes benefícios para o
                    curso Técnico em Desenvolvimento de Sistemas e para a sociedade. <br><br> Nossa ferramenta facilita
                    o alcance
        ...
        <div class="sobre-nos-image-container">
            <img class="sobre-nos-image" src="/together/view/assests/images/Geral/img-sobre-nos.png" alt="Imagem sobre nós">
        </div>
    </div>
    <div class="sobre-nos-cards-section">
        <div class="sobre-nos-cards-container">
            <div class="sobre-nos-card">
                ...
                <p>Bem-vindo ao nosso site, um espaço dedicado a conectar e promover ONGs de todo o país! Nossa missão é
            ...
            <div class="sobre-nos-card">
                <h2>Nossa Missão</h2>
                <p>Acreditamos no poder da união e na força das iniciativas sociais. Nosso objetivo é reunir as melhores
            ...
            <div class="sobre-nos-card">
                ...
                <p><strong>Transparência:</strong> Acreditamos na importância da honestidade e clareza nas informações,
        ...
        <div class="sobre-nos-cards-container">
            <div class="sobre-nos-card">
                ...
                <p>Nosso site foi idealizado com o objetivo de criar um ponto de encontro virtual para ONGs que buscam
            ...
            <div class="sobre-nos-card">
                ...
                <p>Diferente de outras plataformas, nosso site é exclusivo para ONGs, com um foco dedicado em seus
                    ...
                    inclusão, criando uma comunidade diversa e rica em soluções criativas para os problemas sociais.</p>
            </div>
            <div class="sobre-nos-card">
