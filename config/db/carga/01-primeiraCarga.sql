...
-- 3) Endereços 
INSERT INTO enderecos (logradouro, numero, cep, complemento, bairro, id_cidade) VALUES
  ('Rua A', 100, '79000000', NULL, 'Centro', 1),
  ('Av. B', 200, '79010000', 'Apto 12', 'Amambaí', 2),
  ('Rua C', 300, '01010000', NULL, 'Bela Vista', 3),
  ('Av. D', 400, '30100000', 'Bloco C', 'Funcionários', 4);
