<?php
    $vetor = [
        ...
        [
            ...
            "linkedin" => "?=usuarioNãoPossuiLinkedin",
            "imagem" => "../assests/images/Copyright/togetherteam/vicente.jpg"
        ],
        [
            "nome" => "Ariel David",
            "github" => "https://github.com/ArielDavid79",
            "linkedin" => "www.linkedin.com/in/ariel-leza-39680455",
            "imagem" => "../assests/images/Copyright/togetherteam/david.jpg"
        ],   
        [
            // https://github.com/RhyanSKomm
            // www.linkedin.com/in/rhyan-komm-695699245
            "nome" => "Rhyan Komm",
            "github" => "?=usuarioNãoPossuiGithub",
            "linkedin" => "?=usuarioNãoPossuiLinkedin",
            "imagem" => "../assests/images/Copyright/togetherteam/komm.jpg"
        ],
        [
            "nome" => "Allan Fernandes",
