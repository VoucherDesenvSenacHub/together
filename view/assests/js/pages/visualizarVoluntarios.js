document.addEventListener("DOMContentLoaded", function () {
  ...
  const buttonArea = document.querySelector(".confirmacao-area-visualizar-voluntarios"); // Seleciona a div dos botões
  ...
  function hideButtonArea() {
    buttonArea.style.display = "none"; // Esconde a div inteira dos botões
  }
