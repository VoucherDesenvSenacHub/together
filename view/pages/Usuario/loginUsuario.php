...
<body class="body-login-usuario">
    ...
    <div class="container-login-usuario">
        ...
        <div class="recuperar-conta-login-usuario hidden" id="recuperarContent">
            <div class="box-login-usuario">
                ...
                <form class="login-usuario">
                    <button id="house-button-login-usuario"><i class="fa-solid fa-house fa-xl" id="house-icon-login-usuario"></i></button>
                    ...
                    <input type="text" placeholder="Email" class="text-input-login-usuario" id="email-input">
        ...
        <div class="registrar-conta-login-usuario hidden" id="registrarContent">
            <div class="box-login-usuario">
                <form class="registrar-box-login-usuario">
                    ...
                    <input type="password" placeholder="Digite sua Senha" class="register-input-login-usuario" id="senha-input">
    ...
    <script>
        ...
        document.getElementById('house-icon-login-usuario').addEventListener('click', function (event) {
            event.preventDefault(); // Previne o comportamento padrão do botão
