                ...
                <?php if ($_SESSION['perfil'] === 'Administrador') { ?>
                        ...
                        <aside class="aside-area">
                                <div class="aside-content" id="sideAdministrador">
                                        ...
                                        <a title="Patrocinadores" href="/together/view/pages/Adm/gestaoDePatrocinadores.php" class="aside-button" id="categoriaButton"> 
                ...
                <?php } elseif ($_SESSION['perfil'] === 'Ong') { ?>
                        ...
                        <aside class="aside-area">
                                <div class="aside-content" id="sideOng">
                                        ...
                                        <a title="Ongs Voluntariado" href="/together/view/pages/Usuario/usuarioOngsVoluntarias.php" class="aside-button"> 
                                ...
                                <div class="aside-content">
                                        ...
                                        <a title="Visão sobre Ong" href="/together/view/pages/visaoSobreaOng.php" class="aside-button" id="categoriaButton"> 
                                        ...
                                        <a title="Voluntarios Pendentes da Ong" href="/together/view/pages/Ong/validacaoVoluntario.php" class="aside-button"> 
