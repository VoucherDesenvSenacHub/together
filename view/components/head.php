...
<head>
    ...
    <link rel="stylesheet" href="/together/view/assets/css/style.css">
    ...
    <link rel="shortcut icon" href="/together/view/assets/images/components/logoTogetherLoginMobile.png" type="image/x-icon">
